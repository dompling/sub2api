...
function setDecision(value: string | number | boolean | null) {
  localFilters.decision = String(value ?? '')
  filtersChanged()
}
function setRiskLevel(value: string | number | boolean | null) {
  localFilters.risk_level = String(value ?? '')
  filtersChanged()
}
