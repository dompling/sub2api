export default {
  ...
  keys: {
    ...
    modelWhitelistPlaceholder: 'gpt-*\nclaude-sonnet-*',
    modelWhitelistHint: 'One model per line. Supports exact names and a trailing * (for example, gpt-*). Leave empty to add no restriction for this key; group restrictions still apply.',
