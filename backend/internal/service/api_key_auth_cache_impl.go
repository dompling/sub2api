...
const apiKeyAuthSnapshotVersion = 26 // v26: v25 group model_allowlist and billing/manifest fields + key-level allowed_models; invalidate snapshots from either fork.
