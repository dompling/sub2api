...
--   - user_platform_quotas / composite_model_routes：service.AllowedQuotaPlatforms 全部 13 项（含 CodeBuddy）
...
ALTER TABLE user_platform_quotas
    ...
    CHECK (platform IN ('anthropic', 'openai', 'gemini', 'antigravity', 'grok',
                        'kimi', 'zhipu', 'deepseek', 'kiro', 'minimax', 'adobe', 'opencode_go', 'codebuddy'));
